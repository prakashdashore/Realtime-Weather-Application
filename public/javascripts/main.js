  ...
  if (val.trim().length > 1) {
    axios
      ...
      .then(function (respons) {
        ...
        // console.log(respons.data.sys.country)
        // console.log(respons.data.sys.sunrise)
        // console.log(respons.data.sys.sunset)
        // console.log(respons.data.timezone)
        // console.log(respons.data.dt)
        // console.log(recent)
        ...
        // country.innerHTML = respons.data.sys.country;
      });
  } else {
